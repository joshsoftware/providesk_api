class NotifyMailer < ApplicationMailer
  ...
  def notify_status_change(receiver, secondary_receiver, description, ticket_number, ticket_link)
    ...
    mail(to: receiver.email, cc: secondary_receiver.email, subject: "Ticket-#{ticket_number} progress notifcation")
  end

  def notify_status_escalate(receiver, secondary_receiver, description, ticket_number, ticket_link)
    @description, @ticket_link = description, ticket_link
    mail(to: receiver.email, cc: secondary_receiver.email, subject: "Ticket-#{ticket_number} escalation notification")
  end
